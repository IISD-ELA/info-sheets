...
- [General information](#general-information)
  * [Acronyms](#acronyms)
  * [Datasets](#datasets)
  * [Hydrometric Program History](#hydrometric-program-history)
    * [Water Survey of Canada station numbers](#water-survey-of-canada-station-numbers)
  * [Stream Temperature Instrumentation](#stream-temperature-instrumentation)
...
### Stream Temperature Instrumentation

The below was copied directly from the [lake temperature info sheet](lake-temp.md) and will need to be modified to focus only on information relevant to *stream* temperature instrumentation (exclude *lake*).
