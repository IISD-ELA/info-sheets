...
Sometimes ECCC data points are used to fill gaps in the datasets included here (both instruments are located at the IISD-ELA metsite), and for quality control to cross-compare sensors. We acknowledge these contributions to increase the value and usability of the datasets, and we include a copy of ECCC's data license in this package. Please see ECCC's license agreement for more information: [https://climate.weather.gc.ca/prods_servs/attachment1_e.html](https://climate.weather.gc.ca/prods_servs/attachment1_e.html).
