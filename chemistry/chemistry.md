...
| analysis_employee | character varying | N/A | The username of the employee (First Initial - Last Name, e.g. shavens) who performed the analysis. | 
| approved_by | character varying | N/A | The person who approved the entry of the data, if applicable. | 
| approved_date  | date | N/A | The date the data was approved on (YYYY-MM-DD). | 
...
| client_name | character varying | N/A | The client's contact which the analysis was requested to be performed for. |  
...
| entered_by | character varying | N/A | The username of the person who entered the data | 
| entered_date | date | N/A | The data the data was entered into SampleMaster (YYYY-MM-DD).  | 
| laboratory\_name | character varying | N/A | The name of the laboratory that conducted the analysis on the sample in question. |
...
| monitoring\_location\_name | character varying | N/A | Name of sampled or surveyed geographic location at the IISD Experimental Lakes Area field site. The name consists of codes for up to three parts: location, sublocation, and station. Location is typically the lake number (each lake is named with a number, representing the lake's geographical watershed area), sublocation typically specifies LA for "lake" (or a basin, e.g. NB for north basin, or a stream, e.g. IF for inflow, or some other code), station for a specific point (often CB for centre buoy - at about the deepest point of the lake, but several other station types exist). Sometimes the monitoring location description is provided as well as the name, to clarify the meaning. Some names do not have all three parts since a broader area is in question (e.g. for bathymetry, the entire lake, not just the centre buoy, e.g. 239 LA). |
